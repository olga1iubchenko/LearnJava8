...
public abstract class Java7AggregationDuplicatesPerformanceTest {
    ...
    public Java7AggregationDuplicatesPerformanceTest(Aggregator aggregator) {
    ...
    @Test
    public void test() {
        new Timer("Time of test run of method to calculate words duplicates for aggregator based on Java7") {{
